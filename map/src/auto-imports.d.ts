...
declare global {
  ...
  const useInfoModalStore: (typeof import("./stores/useInfoModalStore"))["useInfoModalStore"];
  const useMapLayers: (typeof import("./composables/useMapLayers"))["useMapLayers"];
  const useModel: (typeof import("vue"))["useModel"];
  const usePanoramaStore: (typeof import("./stores/usePanoramaStore"))["usePanoramaStore"];
  const useSelectedFeatureStore: (typeof import("./stores/useSelectedFeatureStore"))["useSelectedFeatureStore"];
...
declare module "vue" {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useInfoModalStore: UnwrapRef<
      (typeof import("./stores/useInfoModalStore"))["useInfoModalStore"]
    >;
    readonly useMapLayers: UnwrapRef<
      (typeof import("./composables/useMapLayers"))["useMapLayers"]
    >;
    readonly useModel: UnwrapRef<(typeof import("vue"))["useModel"]>;
    readonly usePanoramaStore: UnwrapRef<
      (typeof import("./stores/usePanoramaStore"))["usePanoramaStore"]
    >;
    readonly useSelectedFeatureStore: UnwrapRef<
      (typeof import("./stores/useSelectedFeatureStore"))["useSelectedFeatureStore"]
    >;
